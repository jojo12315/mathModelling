...
from AttentionBasedConvLSTM import *
...
if __name__ == '__main__':
    ...
    model = AttentionBasedConvLSTM(3, 1 ,(3,3), 1, True, False, False)
    UNet3D_param = torch.load("att_Based_Conv_LSTM.pt")
    ...
    for dbz, kdp, zdr, label in train_dataloader:
        ...
        numpy.save("att_ConvLSTM_pred_validate/pred"+str(count),model(train_input)[0][0].cpu().data.numpy())
        count+=1
