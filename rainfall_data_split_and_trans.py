        ...
        for h in height:
            ...
            for i in range(0,train_num):
                ...
                for k in range(file_num):
                    shutil.copy(path+c+"/"+h+"/"+dirs[i]+"/"+files[k], savePath+"/"+c+"/"+dataSet[0]+"/"+files[k])
            ...
            for i in range(train_num,validate_num):
                ...
                lenCount[getIndex(file_num)] += 1
                for k in range(20):
                    shutil.copy(path+c+"/"+h+"/"+dirs[i]+"/"+files[k], savePath+"/"+c+"/"+dataSet[1]+"/"+files[k])
            ...
            for i in range(validate_num,test_num):
                ...
                lenCount[getIndex(file_num)] += 1
                for k in range(file_num):
                    shutil.copy(path+c+"/"+h+"/"+dirs[i]+"/"+files[k], savePath+"/"+c+"/"+dataSet[2]+"/"+files[k])
